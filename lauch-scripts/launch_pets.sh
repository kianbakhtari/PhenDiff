...
run_name=PhenDiff_pets_uncond_SubjectOnly_no_aug_super_small_denoiser_config # wandb run display name
...
--train_data_dir /projects/deepdevpath/Kian/datasets/pet-dataset/subject_only/
--definition 128
--train_batch_size 64
--eval_batch_size 256
--max_num_steps 50000
